    ...
    public static void help(String command) {
        if(command.equalsIgnoreCase("help")) {
            ...
            if(command.split(" ")[1].equalsIgnoreCase("1")) {
                ...
                Console.println("§whiteclear §light_grey- Clears all lines from the current com.anomaly.console", false, Color.LIGHT_GRAY);
                Console.println("§whitestop §light_grey- Stops com.anomaly.Anomaly", false, Color.LIGHT_GRAY);
